...
tables combine both orders, accept every sample, and show full ranges. The
summary and exact commands are under
[`../../../benchmarks/disequality/reports/set-de-follow-up/`](../../../benchmarks/disequality/reports/set-de-follow-up/).
Historical raw-output hashes are in
[`../../../benchmarks/disequality/reports/RAW_RESULT_HASHES.md`](../../../benchmarks/disequality/reports/RAW_RESULT_HASHES.md);
raw Hyperfine JSON is no longer tracked.
