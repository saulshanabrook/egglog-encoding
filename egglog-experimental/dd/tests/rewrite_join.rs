...
use egglog_backend_trait::{
    Backend, ColumnTy, DefaultVal, FunctionConfig, MergeExpr, MergeInputSide, MergeProgram,
    MergeValueColumn, ReadMode, RuleActionCall, RuleBodyCall, RuleSetRun, RuleSpec, RuleValue,
    RuleVar,
};
...
fn index_only_body_joins_instead_of_firing_once() {
    ...
    eg.flush_updates().expect("seed row should be accepted");
    ...
    eg.flush_updates()
        .expect("index-only rule result should be accepted");
