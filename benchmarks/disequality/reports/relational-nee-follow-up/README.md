...
order; medium Propel used three. Every sample was accepted. Raw JSON is no
longer tracked; its hashes are preserved in
[`../RAW_RESULT_HASHES.md`](../RAW_RESULT_HASHES.md).
