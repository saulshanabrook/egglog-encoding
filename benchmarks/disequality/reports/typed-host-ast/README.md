...
This historical report compares the isolated typed-AST host adapter commit with its
...
Raw Hyperfine JSON is no longer tracked. Its hashes, including the provenance
hash, are preserved in [`../RAW_RESULT_HASHES.md`](../RAW_RESULT_HASHES.md).
The current post-merge gate is documented separately in
