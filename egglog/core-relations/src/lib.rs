...
pub use receipts::{
    ...
    CheckReceiptSpec, CheckRoot, ContainerDependency, DeferredEqualityCause, EqComponentRef,
    EqLeafId, EqLeafRecord, EqNodeId, EqNodeRecord, EqualityEdgeCount, EqualityEdgeId,
    EqualityEndpoint, EqualityLandmark, EqualityReason, EqualityRecord, EqualitySupport, FactCause,
    FactCellRef, FactId, FactRecord, HistoricalFactCell, HistoryPosition, MatchRecord,
    MergeOriginSelector, NativeAliasRecord, PreparedRekey, ProjectedAppliedEquality,
    RawAliasWindow, RawAppliedEquality, RawEqualityEndpoint, RawEqualitySupport, RawFactRecord,
    RawMatchRecord, RawReceiptCause, RawRekeyRecord, RawTermAvailability, RebuildDependency,
    ReceiptCauseDependency, ReceiptCauseId, ReceiptCausePrior, ReceiptCauseRecord, ReceiptCauseRef,
    ReceiptCounters, ReceiptEqualitySource, ReceiptPremiseOccurrence, ReceiptSnapshot,
    ReceiptViewError, RekeyOutcome, RemovalRecord, ReplayConstructorSpec, ReplayLiteral,
    ReplayOpId, ReplaySortId, ReplayTableKind, ReplayTableSchema, ReplayTerm, ReplayTermCounters,
    ReplayTermId, RowOriginSiteId, RuleBindingSpec, RuleMatchId, RuleReceiptSpec,
