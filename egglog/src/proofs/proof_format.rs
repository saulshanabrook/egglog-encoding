...
///
/// Compared to the internal raw proof form, a [`Justification`] is always paired with the [`Proposition`] being proven (in a [`Proof`]).
/// Additionally, [`Justification::Rule`] includes the explicit substitution mapping variable names to terms,
/// while the internal rule proof leaves this implicit.
#[derive(Clone, Debug)]
pub enum Justification {
    ...
    /// for each premise ([`crate::ast::Fact`]) of the rule.
