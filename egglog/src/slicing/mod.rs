...
//! egglog commands that own no handles or runtime values from the recording
//! graph.
//!
...
/// source commands and firings, and returns ordinary egglog commands suitable
/// for a fresh, equivalently configured graph.
///
