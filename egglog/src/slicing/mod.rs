...
///
/// Trace capture must have been enabled with [`EGraph::enable_trace`] before
/// user declarations or input were installed. The returned source is not run
/// or validated; callers choose whether and under which execution mode to run
/// it.
